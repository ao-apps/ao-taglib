		...
		DynamicAttributes
{
	...
	@Override
	public void setClazz(String clazz) throws JspTagException { // TODO: This extensive use of JspTagException on setters should probably be IllegalArgumentException
