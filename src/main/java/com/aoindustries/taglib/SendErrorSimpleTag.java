 ...
 */
public class SendErrorSimpleTag extends com.aoindustries.encoding.taglib.EncodingBufferedSimpleTag {

	public SendErrorSimpleTag() {
		init();
	}
...
/**/
	...
	@Override
/* BodyTag only:
	protected int doEndTag(Writer out) throws javax.servlet.jsp.JspTagException, IOException {
/**/
/* SimpleTag only: */
	protected void doTag(BufferResult capturedBody, Writer out) throws javax.servlet.jsp.JspException, IOException {
