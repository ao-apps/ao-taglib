...
public class HtmlTag extends ElementFilteredTag {
  ...
  /**
   * @deprecated  Please use {@link HtmlTag#beginHtmlTag(javax.servlet.ServletResponse, java.lang.Appendable, com.aoapps.encoding.Serialization, com.aoapps.taglib.GlobalAttributes)}
   */
  @Deprecated
