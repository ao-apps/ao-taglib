...
import static com.aoapps.taglib.WidthTag.TAG_NAME;
 ...
 */
public class WidthTag extends EncodingBufferedBodyTag {
  ...
  protected int doEndTag(BufferResult capturedBody, Writer out) throws JspException, IOException {
    ...
    AttributeUtils.requireAttributeParent(TAG_NAME, this, "width", WidthAttribute.class)
        .setWidth(trimmed.isEmpty() ? null : Integer.valueOf(trimmed));
    /* BodyTag only: */
    return EVAL_PAGE;
    /**/
  }
