 ...
 * Copyright (C) 2011, 2012, 2013, 2016, 2017, 2020, 2021, 2022, 2025, 2026  AO Industries, Inc.
...
import static com.aoapps.taglib.FrameborderTag.RESOURCES;
import static com.aoapps.taglib.FrameborderTag.TAG_NAME;
  ...
  protected int doEndTag(BufferResult capturedBody, Writer out) throws JspException, IOException {
    ...
    if (!value.isEmpty()) {
      if ("true".equalsIgnoreCase(value)) {
        frameborderAttribute.setFrameborder(true);
      } else if ("false".equalsIgnoreCase(value)) {
        frameborderAttribute.setFrameborder(false);
      } else {
