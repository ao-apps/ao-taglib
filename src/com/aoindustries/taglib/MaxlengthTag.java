...
public class MaxlengthTag extends AutoEncodingBufferedTag {
    ...
    protected void doTag(AutoTempFileWriter capturedBody, Writer out) throws JspException, IOException {
        JspTag parent = findAncestorWithClass(this, MaxlengthAttribute.class);
        if(parent==null) throw new NeedAttributeParentException("maxlength", "maxlength");
        MaxlengthAttribute maxlengthAttribute = (MaxlengthAttribute)parent;
